...
local getcustomassets = {
	['spoofz/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['spoofz/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['spoofz/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['spoofz/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['spoofz/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['spoofz/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['spoofz/assets/old/info.png'] = 'rbxasset://info.png',
	['spoofz/assets/old/pin.png'] = 'rbxasset://pin.png',
	['spoofz/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['spoofz/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['spoofz/assets/old/search.png'] = 'rbxasset://search.png',
	['spoofz/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['spoofz/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['spoofz/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['spoofz/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['spoofz/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['spoofz/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['spoofz/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['spoofz/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/thegrateminecra/spoofz/main/'..select(1, path:gsub('spoofz/', '')), true)
		end)
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('spoofz/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('spoofz/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('spoofz/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('spoofz/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('spoofz/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('spoofz/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('spoofz/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('spoofz/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('spoofz/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('spoofz/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('spoofz/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('spoofz/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('spoofz/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('spoofz/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('spoofz/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('spoofz/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('spoofz/assets/old/profilesicon.png'),
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.SpoofzDeveloper then
				loadstring(readfile('spoofz/loader.lua'), 'loader')()
			else
				loadstring(game:HttpGet('https://raw.githubusercontent.com/thegrateminecra/spoofz/'..getcommit()..'/loader.lua', true))()
			end
		end
	end,
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('spoofz/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('spoofz/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('spoofz/assets/old/textv4.png')
